...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 style="text-align: center">{{ __('Crear temporada') }}</h1>
            <div class="card">
                <div class="card-body" style="text-align: left">
                    <form method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mod_temporada" type="number" class="form-control @error('mod_temporada') is-invalid @enderror" name="mod_temporada" required autocomplete="mod_temporada" autofocus>
